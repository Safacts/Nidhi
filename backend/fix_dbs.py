...
for instance in instances:
    # Use db_name or project_slug to find 'vitarn'
    slug = getattr(instance, 'project_slug', 'N/A')
    print(f"DB Instance: {instance.db_name}, User: {instance.db_user}, Slug: {slug}")
    
    if 'vitarn' in instance.db_name.lower() or 'vitarn' in slug.lower() or 'vitharn' in instance.db_name.lower() or 'vitharn' in slug.lower():
